...
ARCHIVE_NAME="reports_modal_deploy.tar.gz"

echo "Bundling reports layout..."
...
echo "Extracting bundle on production and clearing view caches..."
...
echo "Reports layout updated on production successfully!"

...
ARCHIVE_NAME="bulk_delete_sections_deploy.tar.gz"

echo "Bundling bulk delete sections updates..."
...
echo "Bulk delete sections deployed successfully on production!"

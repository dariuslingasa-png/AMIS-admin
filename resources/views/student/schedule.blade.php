                            ...
                            <div class="teacher-strip" style="background: #f8fafc; border-bottom: 1.5px solid #e2e8f0; height: 110px; display: grid; grid-template-columns: 90px 1fr;">
                                ...
                                <div style="display: flex; align-items: start; gap: 0.75rem; padding: 1rem; min-width: 0;">
                                    ...
                                    <div style="min-width: 0; flex: 1;">
                                        ...
                                        <p style="font-size: 0.65rem; font-weight: 850; color: #94a3b8; text-transform: uppercase; margin: 0.5rem 0 0; letter-spacing: 0.05em;">Primary Teacher</p>
                                        <p style="font-size: 0.8rem; font-weight: 750; color: #475569; margin: 0.15rem 0 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="{{ $currentTeacherName }}">{{ $currentTeacherName }}</p>
                                    </div>
                                </div>
                            </div>

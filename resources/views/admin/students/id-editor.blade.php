            ...
            <div class="lg:col-span-2 bg-slate-50 dark:bg-slate-950/20 border border-slate-200 dark:border-slate-850/50 rounded-3xl p-6 flex flex-col items-center justify-center gap-6">
                ...
                <div class="flex flex-row items-start justify-center gap-4 w-full overflow-x-auto pb-4">
                    ...
                    <div class="flex flex-col items-center gap-2 flex-shrink-0">
                        ...
                        <div style="transform: scale(0.83); transform-origin: top center; margin-bottom: -75px;">
                        ...
                        <div id="id-card-back-box" class="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200/80 dark:border-slate-800" style="width: 280px; height: 443px; background-color: #064e3b;">
                            ...
                            <div style="position: absolute; left: 23px; top: 70px; width: 233px; z-index: 10; display: flex; flex-direction: column; gap: 5.5px;">
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 8px;">
                                    ...
                                    <div style="text-align: left; font-family: 'Outfit', sans-serif; font-size: 10px; font-weight: 800; text-transform: uppercase; color: #64748b;">
                                        @php
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 8px;">
                                    ...
                                    <div style="text-align: left; font-family: 'Outfit', sans-serif; font-size: 12px; font-weight: 900; color: #0f172a;">
                                        {{ $emergencyPhone }}
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 8px;">
                                    ...
                                    <div style="text-align: left; font-family: 'Outfit', sans-serif; font-size: {{ $addressFontSize }}; font-weight: 800; color: #334155; line-height: 1.15; text-transform: uppercase;">
                                        {{ $homeAddress }}
                                    </div>
                                </div>
                            </div>

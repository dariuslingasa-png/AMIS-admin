...
<head>
    ...
    <title>AMIS Official Grade Roster - {{ $grade }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .page { width: 210mm; min-height: 297mm; margin: 20px auto; background: #fff; padding: 18mm 16mm; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1); border-radius: 8px; }
        ...
        @media print {
            ...
            .page { width: auto; min-height: auto; margin: 0; padding: 0; box-shadow: none; border-radius: 0; page-break-after: always; }
        ...
        <main class="page">
            ...
            <table class="meta">
                <tr>
                    ...
                    <td class="value">{{ $sectionDisplayName }}</td>
                </tr>
                <tr>
                    <td class="label">Shift / Mode</td>
                    <td class="value">{{ $section->shift ?: $secLearningModeLabel }}</td>
                    <td class="label">Grade Advisor</td>
                    <td class="value">{{ str_ireplace('TEACHER ', '', $section->advisor_name) }}</td>
                </tr>
                <tr>
                    ...
                    <td class="value">{{ $section->occupied }} / {{ $section->capacity_limit }} ({{ $section->fill_rate }}%)</td>
                </tr>
            </table>

        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            @if(isset($students) && count($students) === 1)
                ...
                <h3 style="margin: 0; font-size: 13px; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 6px; font-family: Inter, Arial, sans-serif;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    <span>Student Record Info Sheet - {{ $singleStudent->student_number }}</span>
                </h3>
            @else
                <h3 style="margin: 0; font-size: 13px; font-weight: 800; color: #0f172a; font-family: Inter, Arial, sans-serif;">Student Records Master List</h3>
            @endif
            <div style="display: flex; gap: 8px; align-items: center;">
                <button type="button" onclick="window.print()" style="font-family: Inter, sans-serif;">Print / Save PDF</button>
            </div>
        </div>

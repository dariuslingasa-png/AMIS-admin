        ...
        <x-card title="Enrollee Masters List" subtitle="Filtered enrollment export and masters list">
            ...
            <form method="GET" class="mb-6 grid grid-cols-1 sm:grid-cols-12 gap-3 items-end">
                ...
                <div class="col-span-1 sm:col-span-2 flex gap-2">
                    <a href="{{ route('admin.enrollment.masters-list') }}" class="flex h-10 w-1/2 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-600 font-semibold text-xs transition" title="Clear Filters">
                        <i data-lucide="rotate-ccw" class="h-4 w-4"></i>
                    </a>
                    <a href="{{ route('admin.enrollment.masters-list.export', request()->query()) }}" class="flex h-10 w-1/2 items-center justify-center rounded-lg bg-emerald-700 hover:bg-emerald-800 text-white font-semibold text-xs transition shadow-3xs" title="Export CSV">

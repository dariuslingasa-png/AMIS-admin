    ...
    <div class="relative overflow-hidden p-6 md:p-8 bg-gradient-to-r from-emerald-800 to-teal-950 rounded-2xl border border-emerald-700/30 shadow-sm text-white print-hide">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-1 bg-emerald-950/60 p-1.5 rounded-2xl border border-emerald-500/30 backdrop-blur-md shrink-0">
                <a href="{{ route('admin.registrations.halaqah') }}" class="flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl transition text-emerald-200 hover:text-white hover:bg-emerald-800/50">
                    <i data-lucide="graduation-cap" class="w-4 h-4"></i>
                    <span>Students</span>
                </a>
                <a href="{{ route('admin.registrations.halaqah-parents') }}" class="flex items-center gap-2 px-4 py-2 text-xs font-black rounded-xl transition bg-emerald-500 text-slate-950 shadow-md">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-slate-200/70 dark:border-gray-700/50 p-5 shadow-sm mt-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 print-hide">
        <div class="flex flex-col sm:flex-row sm:items-center gap-4 w-full lg:w-auto">
            ...
            <div class="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl shrink-0">
                <a href="{{ route('admin.registrations.halaqah') }}" class="px-3.5 py-2 text-xs font-extrabold rounded-lg transition text-slate-500 hover:text-slate-900 dark:hover:text-slate-300 flex items-center gap-1.5">
                    <i data-lucide="graduation-cap" class="w-3.5 h-3.5"></i>
                    <span>Students</span>
                </a>
                <a href="{{ route('admin.registrations.halaqah-parents') }}" class="px-3.5 py-2 text-xs font-extrabold rounded-lg transition bg-white dark:bg-gray-700 text-emerald-700 dark:text-emerald-400 shadow-xs flex items-center gap-1.5">

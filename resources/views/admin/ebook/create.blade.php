    ...
    <section class="mx-auto max-w-4xl">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-black tracking-tight text-slate-950">Upload eBook</h1>
                <p class="mt-1 text-sm font-semibold text-slate-500">Add a PDF and publish it to the public eBook catalog.</p>
            </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            @include('admin.ebook.partials.form', [
                'action' => route('admin.ebook.store'),
                'book' => $book,

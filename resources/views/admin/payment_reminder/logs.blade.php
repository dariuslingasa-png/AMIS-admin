<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.payment-reminder.preview', $campaign) }}"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3">
                @foreach([
                    ...
                    <a href="{{ route('admin.payment-reminder.logs', ['campaign' => $campaign, 'status' => strtolower($label)]) }}"
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                <form method="GET" action="{{ route('admin.payment-reminder.logs', $campaign) }}"

...
$email = 'sir_monlingasa@amis.edu.ph';

echo "Setting up Grade 1 Student Account for: {$email} ...\n";

// 1. User
$user = User::where('email', $email)->first();
if (!$user) {
    $user = new User();
    $user->username = 'sir_monlingasa';
...
// 4. Student
Student::where('student_number', '260000')->where('school_email', '!=', $email)->delete();
...
echo "SUCCESS! Account {$email} is fully registered with Student role (Grade 1).\n";

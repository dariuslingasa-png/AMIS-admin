...
$student->section = $section->name ?? 'Grade 1';
$student->save();
...
echo "SUCCESS! Account mon.lingasa@amis.edu.ph is fully registered with Student role (Grade 1).\n";
